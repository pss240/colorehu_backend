...
class ColorSet(models.Model):
    ...
    color2 = models.CharField(max_length=200,blank=True,default='')
    color3 = models.CharField(max_length=200,blank=True,default='')
    color4 = models.CharField(max_length=200,blank=True,default='')
    color5 = models.CharField(max_length=200,blank=True,default='')
